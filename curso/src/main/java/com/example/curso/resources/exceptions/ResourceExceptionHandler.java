...
@ControllerAdvice // interceptar as excessoes
public class ResourceExceptionHandler implements Serializable {

	
	private static final long serialVersionUID = 1L;

	@ExceptionHandler(ResourceNotFoundException.class) // para interceptar a excessao neste caso  ResourceNotFoundException
